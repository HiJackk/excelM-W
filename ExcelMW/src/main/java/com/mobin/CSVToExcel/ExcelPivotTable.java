...
public class ExcelPivotTable {
    ...
    public void pivotTable(String originPath) {
        try (XSSFWorkbook wb = new XSSFWorkbook(new FileInputStream("/Users/mac/Downloads/CSVToExcel-master/src/main/java/com/mobin/CSVToExcel/sj.xlsx"));
             FileOutputStream out = new FileOutputStream("ssj.xlsx")) {
...
//        } else {
            ...
            excelPivotTable.pivotTable("/Users/mac/Downloads/CSVToExcel-master/src/main/java/com/mobin/CSVToExcel/sj.xlsx");
        //}
